          ...
          return (
            ...
            >
              <span className="relative">
                ...
                {badge > 0 && (
                  <span className="absolute -top-1.5 -right-2 min-w-[14px] h-3.5 px-0.5 bg-[var(--amber)] text-[var(--navy)] font-semibold text-[9px] leading-3.5 text-center tabular-nums">
                    {badge > 9 ? '9+' : badge}
                  </span>
                )}
              </span>
