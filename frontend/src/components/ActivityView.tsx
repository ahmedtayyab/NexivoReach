    ...
    <div className="max-w-5xl">
      ...
      {agentLogs.length === 0 ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          <div className="lg:col-span-4 bg-panel border border-border rounded-lg p-3 space-y-1">
          ...
          {selectedLog && (
            <div className="lg:col-span-8 bg-panel border border-border rounded-lg p-5 space-y-4">
              ...
              <div className="flex flex-wrap gap-1.5">
                {selectedLog.toolsUsed.map((tool, idx) => (
                  <span key={idx} className="text-[11px] bg-muted text-ink-secondary border border-border px-2 py-0.5 rounded">
                    {tool}
                  </span>
                ))}
              </div>
              ...
              <div className="space-y-3">
                {selectedLog.decisions.map((dec, idx) => (
                  <div key={idx} className="border border-border rounded-lg p-3.5 space-y-2">
